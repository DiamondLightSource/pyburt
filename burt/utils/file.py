...
def is_req_file(filename):
    """Checks if a given filename refers to a .req file.
...
def is_snap_file(filename):
    """Checks if a given filename refers to a .snap file.
...
def is_rqg_file(filename):
    """Checks if a given filename refers to a .rqg file.
...
def is_rgr_file(filename):
    """Checks if a given filename refers to a .rgr file.
...
def is_check_file(filename):
    """Checks if a given filename refers to a .check file.
...
def _is_correct_ext(filename, correct_ext):
    """Checks if a given filename has the expected file extension.
